...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"乐居","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  ...
  // 模块的 mutations 方法
  mutations: {
    allCart: function allCart(state, _allCart) {
      state.cart = _allCart;
    ...
    // 更新购物车的选中状态
    updateStatus: function updateStatus(state, good) {
      var findResult = state.cart.find(function (x) {return x.id === good.goods_id;});
    ...
    // // 更新购物车中商品的数量
    updateGoodsCount: function updateGoodsCount(state, objParams) {
      // 根据 goods_id 查询购物车中对应商品的信息对象
      var findResult = state.cart.find(function (x) {return x.id === objParams.id;});
    ...
    // 删除购物车的数据
    deleteGoods: function deleteGoods(state, good) {
      // 根据 goods_id 查询购物车中对应商品的信息对象的索引
      var findResultIndex = state.cart.findIndex(function (x) {return x.id === good.id;});
  ...
  getters: {
    ...
    total: function total(state) {
      return state.cart.reduce(function (total, item) {return total += item.quantity;}, 0);
    },
    // 勾选的商品的总数量
    checkedCount: function checkedCount(state) {
      ...
      return state.cart.filter(function (x) {return x.goods_state;}).reduce(function (total, item) {return total += item.quantity;}, 0);
    },
    // 已勾选的商品的总价
    checkedGoodsAmount: function checkedGoodsAmount(state) {
      ...
      reduce(function (totalPrice, item) {return totalPrice += item.quantity * item.price;}, 0).
      toFixed(2);
...
/***/ 136:
/*!*******************************************!*\
  !*** D:/项目/uni-leju/api/address/index.js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.addAddressInfo = addAddressInfo;exports.delAddressInfo = delAddressInfo;exports.findAllAddress = findAllAddress;exports.switchDefault = switchDefault;exports.updateAddressInfo = updateAddressInfo;var _index = __webpack_require__(/*! @/api/index.js */ 25);
...
/***/ 154:
/*!**********************************************!*\
  !*** D:/项目/uni-leju/api/user/order/index.js ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.findAllOrders = findAllOrders;exports.orderReturnApplys = orderReturnApplys;exports.cancelOrder = cancelOrder;exports.receiveDone = receiveDone;exports.getCompanyAddrss = getCompanyAddrss;exports.addOrderReturnApply = addOrderReturnApply;exports.deleteOrder = deleteOrder;var _index = __webpack_require__(/*! @/api/index.js */ 25);
...
/***/ 184:
/*!**************************************************************************!*\
  !*** D:/项目/uni-leju/uni_modules/uni-icons/components/uni-icons/icons.js ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 206:
/*!***********************************************************************!*\
  !*** D:/项目/uni-leju/uni_modules/mp-html/components/mp-html/parser.js ***!
  \***********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
      ...
      if (children[_i8].type === 'text' && children[_i8 + 1].name === 'rt') {
        children[_i8] = {
          ...
          children: [{
            name: 'div',
            attrs: {
              style: 'font-size:50%;text-align:start;' + (children[_i8 + 1].attrs.style || '') },
...
/***/ 233:
/*!*********************************************************************************************!*\
  !*** D:/项目/uni-leju/uni_modules/uni-swipe-action/components/uni-swipe-action-item/mpwxs.js ***!
  \*********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _isPC = __webpack_require__(/*! ./isPC */ 234);var _default =
{
  data: function data() {
    return {
      position: [],
...
/***/ 234:
/*!********************************************************************************************!*\
  !*** D:/项目/uni-leju/uni_modules/uni-swipe-action/components/uni-swipe-action-item/isPC.js ***!
  \********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 24:
/*!****************************************!*\
  !*** D:/项目/uni-leju/api/home/index.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.bannerAds = bannerAds;exports.findCategory = findCategory;exports.hotList = hotList;exports.recommendList = recommendList;exports.latestProducts = latestProducts;exports.saleMostProducts = saleMostProducts;exports.lejuLatestProducts = lejuLatestProducts;exports.findProductList = findProductList;var _index = __webpack_require__(/*! @/api/index.js */ 25);
...
/***/ 25:
/*!***********************************!*\
  !*** D:/项目/uni-leju/api/index.js ***!
  \***********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.request = void 0;var _baseUrl = _interopRequireDefault(__webpack_require__(/*! ./baseUrl */ 26));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
// 同时发送异步代码的次数
var ajaxTimes = 0;
var request = function request(params) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    params), {}, {
      url: _baseUrl.default + params.url,
      header: header,
...
/***/ 251:
/*!**********************************************************************!*\
  !*** D:/项目/uni-leju/components/simple-address/city-data/province.js ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 252:
/*!******************************************************************!*\
  !*** D:/项目/uni-leju/components/simple-address/city-data/city.js ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 253:
/*!******************************************************************!*\
  !*** D:/项目/uni-leju/components/simple-address/city-data/area.js ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// }
baseUrl = "https://leju.bufan.cloud";var _default =
...
/***/ 35:
/*!****************************************!*\
  !*** D:/项目/uni-leju/api/find/index.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.productArticle = productArticle;exports.findArticleByPage = findArticleByPage;exports.findBrandsByPage = findBrandsByPage;var _index = __webpack_require__(/*! @/api/index.js */ 25);
...
/***/ 42:
/*!********************************************!*\
  !*** D:/项目/uni-leju/api/category/index.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.findCategory = findCategory;exports.findProductList = findProductList;exports.productDetail = productDetail;var _index = __webpack_require__(/*! @/api/index.js */ 25);
...
/***/ 51:
/*!**********************************************!*\
  !*** D:/项目/uni-leju/api/user/login/index.js ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.doLogin = doLogin;exports.getMemberInfo = getMemberInfo;exports.uploadAvatar = uploadAvatar;var _index = __webpack_require__(/*! @/api/index.js */ 25);function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
function getMemberInfo(params) {
  return (0, _index.request)(_objectSpread({
...
/***/ 52:
/*!****************************************!*\
  !*** D:/项目/uni-leju/mixins/isLogin.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...

{
  ...
  (0, _vuex.mapMutations)('m_user', ['updateRedirectInfo'])), {}, {
    isLogin: function isLogin(path) {var _this = this;
    ...
    // 展示倒计时的提示消息
    showTips: function showTips(n, params) {
    ...
    // 延迟导航到 my 页面
    delayNavigate: function delayNavigate(path) {var _this2 = this;
      // 把 data 中的秒数重置成 3 秒
      this.seconds = 3;
...
/***/ 61:
/*!****************************************!*\
  !*** D:/项目/uni-leju/api/user/index.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.register = register;exports.resetPassword = resetPassword;exports.updateMemberInfo = updateMemberInfo;exports.uploadAvatar = uploadAvatar;exports.updatePassword = updatePassword;var _index = __webpack_require__(/*! @/api/index.js */ 25);
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;
var _volidata = _interopRequireDefault(__webpack_require__(/*! ../utils/volidata.js */ 71));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
var _default = {
  ...
  methods: {
    initValidate: function initValidate(rulesObj, messageObj) {
      ...
      //实例化当前的验证规则和提示消息
      this.WxValidate = new _volidata.default(rules, message);
    } } };exports.default = _default;
...
/***/ 71:
/*!****************************************!*\
  !*** D:/项目/uni-leju/utils/volidata.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 80:
/*!*****************************************!*\
  !*** D:/项目/uni-leju/mixins/showTips.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  ...
  methods: {
    // 展示倒计时的提示消息
    showTips: function showTips(n, name) {
      // 调用 uni.showToast() 方法，展示提示消息
      uni.$showMsg({
        title: n + ' 秒后自动跳转到' + name });

    },
    delayNavigate: function delayNavigate(type, path, name) {var _this = this;
      // 把 data 中的秒数重置成 3 秒
      this.seconds = 3;
      ...
      this.timer = setInterval(function () {
        ...
        _this.showTips(_this.seconds, name);
      }, 1000);
    } } };exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
...
/***/ 95:
/*!*****************************************!*\
  !*** D:/项目/uni-leju/api/order/index.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.addPreOrder = addPreOrder;exports.getPreOrderById = getPreOrderById;exports.addConfirmOrder = addConfirmOrder;exports.payConfirm = payConfirm;var _index = __webpack_require__(/*! @/api/index.js */ 25);
...
/***/ 96:
/*!****************************************!*\
  !*** D:/项目/uni-leju/api/cart/index.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.addCart = addCart;exports.clearCart = clearCart;exports.delCartItems = delCartItems;exports.findAllCartItem = findAllCartItem;var _index = __webpack_require__(/*! @/api/index.js */ 25);
...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _isLogin = _interopRequireDefault(__webpack_require__(/*! @/mixins/isLogin.js */ 52));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _toConsumableArray(arr) {return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread();}function _nonIterableSpread() {throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");}function _unsupportedIterableToArray(o, minLen) {if (!o) return;if (typeof o === "string") return _arrayLikeToArray(o, minLen);var n = Object.prototype.toString.call(o).slice(8, -1);if (n === "Object" && o.constructor) n = o.constructor.name;if (n === "Map" || n === "Set") return Array.from(o);if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen);}function _iterableToArray(iter) {if (typeof Symbol !== "undefined" && Symbol.iterator in Object(iter)) return Array.from(iter);}function _arrayWithoutHoles(arr) {if (Array.isArray(arr)) return _arrayLikeToArray(arr);}function _arrayLikeToArray(arr, len) {if (len == null || len > arr.length) len = arr.length;for (var i = 0, arr2 = new Array(len); i < len; i++) {arr2[i] = arr[i];}return arr2;}var _default =
{
  ...
  methods: {
    // 是否收藏的提示框
    CollectedYN: function CollectedYN(item) {
    ...
    collectClick: function collectClick(item, name, path) {
      if (this.isLogin(path)) {
        ...
        var cList = uni.getStorageSync(name);
        var collectList = _toConsumableArray(cList);
        if (cList) {
          // console.log(cList.findIndex(el => el.id == item.id));
          var cIndex = cList.findIndex(function (el) {return el.id == item.id;});
          if (cIndex !== -1) {
